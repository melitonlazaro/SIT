	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        <li><a href=""><span class="glyphicon glyphicon-scale" aria-hidden="true"></span> Dashboard <span class="sr-only"></span></a></li>
	        <li><a href="bc.php?action=adminpage"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;Technical Concern</a></li>
					<li><a href="inventory.php"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Inventory<span class="sr-only"></span></a></li>
				</ul>
